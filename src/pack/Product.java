...
public static List<Product> getProductForworkshopList() {
        ...
        try {
            Connection con = DBClassConnector.getConnection();
            PreparedStatement pst = con.prepareStatement("select * from product where business like 'workshop'");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
...
public static List<Product> getProductForNailList() {
        ...
        try {
            Connection con = DBClassConnector.getConnection();
            PreparedStatement pst = con.prepareStatement("select * from product where business like 'nail'");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
                Product pr = new Product();
    ...
    public static List<Product> getProductForHardwareList() {
        ...
        try {
            Connection con = DBClassConnector.getConnection();
            PreparedStatement pst = con.prepareStatement("select * from product where business like 'hardware'");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
                Product pr = new Product();
