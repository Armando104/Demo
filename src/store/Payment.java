...
public class Payment {
    ...
    public static Payment getPurchase1(String id) {
        Payment pr = null;
        try {
    ...
    public static Payment getPurchase(String id) {
        Payment pr = null;
        try {
            Connection con = DBClassConnector.getConnection();
            PreparedStatement pst = con.prepareStatement("select * from payment where paymentid= " + id + "");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
                pr = new Payment();
                 pr.setPayment_id(rs.getInt(1));
...
public static Object[][]view(){
   List<Payment>l=Payment.getPurchaseList();
   int no=0;
   ...
   return  v;
    ...
    public static List<Payment> getPurchaseList() {
