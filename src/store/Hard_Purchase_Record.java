 ...
 * @author Akilis
 */
public class Hard_Purchase_Record extends javax.swing.JFrame {

    /**
     * Creates new form Hard_Ware
     */
    public Hard_Purchase_Record() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Hardware Purchases Records");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            Purchase.view_Purchase_Records(),
            new String [] {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hard_Purchase_Record.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hard_Purchase_Record().setVisible(true);
            }
        });
    }
